...
urlpatterns = [
    ...
    # Analytics
    path('analytics/usage/', views.analytics_usage, name='analytics-usage'),
    path('analytics/rag-performance/', views.analytics_rag_performance, name='analytics-rag-performance'),
]
